...
$.getJSON("/articles", function (data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var li = $('<li>').appendTo("#articles");


        // Display the apropos information on the page
        $(li).append("<p data-id='" + data[i]._id + "'>" + data[i].title + "<br />" + data[i].link + "</p>");
...
$(document).on("click", "p", function () {
    ...
    $.ajax({
        ...
        .then(function (data) {
            ...
            $("#notes").append("<button data-id='" + data._id + "' id='deleteNotes'>Delete Notes</button>");
